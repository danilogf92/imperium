...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('projects')" :active="request()->routeIs('projects', 'projects.dashboard')" wire:navigate>
                        {{ __('Projects') }}
                    </x-nav-link>

                    <x-nav-link :href="route('data')" :active="request()->routeIs('data', 'projects.data')" wire:navigate>
                        {{ __('Data') }}
                    </x-nav-link>

                    <x-nav-link :href="route('orders')" :active="request()->routeIs('orders', 'projects.orders')" wire:navigate>
                        {{ __('Orders') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('projects')" :active="request()->routeIs('projects', 'projects.dashboard')" wire:navigate>
                {{ __('Projects') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('data')" :active="request()->routeIs('data', 'projects.data')" wire:navigate>
                {{ __('Data') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('orders')" :active="request()->routeIs('orders', 'projects.orders')" wire:navigate>
                {{ __('Orders') }}
            </x-responsive-nav-link>
