<div class="dashboard-page-shell space-y-6">
    ...
    <section x-data="{ open: true }" class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">
                        {{ __('Search and adjust the orders displayed in the table') }}</p>
                </div>
            </div>
        ...
        <div x-show="open" x-collapse>
            <div
                class="flex flex-col gap-4 border-b border-slate-200 bg-slate-50/70 p-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex min-w-0 flex-1 flex-wrap items-center gap-3">
                    ...
                    <x-clear-filters-button method="resetFilters"
                        :active="filled($search) || $plantFilter !== [] || $yearFilter !== [] || $orderFilter !== []" />
                </div>
