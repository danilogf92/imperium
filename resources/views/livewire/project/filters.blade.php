<div x-data="{ open: true }"
    ...
    <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700">
        ...
        <button type="button" x-on:click="open = !open"
            ...
            x-bind:title="open ? 'Collapse' : 'Expand'" x-bind:aria-expanded="open">
            <span class="sr-only" x-text="open ? 'Collapse filters' : 'Expand filters'"></span>
                    ...
                    <button wire:click="projectOrder" wire:loading.attr="disabled" wire:target="projectOrder"
                        ...
                        <span wire:loading.remove wire:target="projectOrder" class="flex items-center gap-2">
                            @if ($orderByProject)
                                ...
                                Ordered by remaining
                            @else
                                Order by remaining
                            @endif
                        </span>
                        <span wire:loading wire:target="projectOrder">Updating...</span>
