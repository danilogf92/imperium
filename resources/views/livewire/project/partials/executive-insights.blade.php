<section class="space-y-4">
    <div class="soft-title-surface rounded-xl border px-5 py-4">
        <p class="text-xs font-bold uppercase tracking-[0.16em] text-indigo-700">{{ __('Executive control') }}</p>
        <h2 class="mt-1 text-lg font-bold text-slate-900">{{ __('Project health and delivery') }}</h2>
        <p class="mt-1 text-sm text-slate-500">{{ __('Financial deviations, planned progress, milestones, weekly execution and information quality.') }}</p>
    </div>
