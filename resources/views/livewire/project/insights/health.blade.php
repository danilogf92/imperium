<article class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
    <p class="text-xs font-bold uppercase tracking-wider text-slate-500">{{ __('Project health') }}</p>
    ...
    <p class="mt-2 text-sm text-slate-500">{{ __('Status, deadlines, financial limits and missing control information.') }}</p>
</article>
