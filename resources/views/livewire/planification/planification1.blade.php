<div class="min-h-screen bg-gray-100 py-6">
            ...
            <div
                ...
                <div class="flex min-w-0 flex-1 items-center gap-3">
                    ...
                    <div class="relative w-full sm:max-w-lg">
                        ...
                        @if (filled($search))
                            <button type="button" wire:click="clearSearch" data-global-loading
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">{{ __('Refine the projects displayed in the timeline') }}
                            </p>
                        </div>
                    </div>
    ...
    @if ($showFormModal)
        ...
        <div wire:key="planification-form-modal"
            class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm" x-data
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select wire:model="milestoneId"
                            ...
                            @foreach ($milestones as $milestone)
                                <option value="{{ $milestone->id }}">{{ $milestone->code }} —
                                    {{ $milestone->name }}
                                </option>
                            @endforeach
                        </select>
