...
<div x-data="{ recovery: false }">
    <div class="mb-6 text-center">
        ...
        <h1 class="mt-3 text-xl font-bold text-slate-900">{{ __('Two-factor authentication') }}</h1>
    ...
    <form method="POST" action="{{ route('two-factor.login.store') }}" class="space-y-5">
        ...
        <x-primary-button class="w-full justify-center">{{ __('Verify and continue') }}</x-primary-button>
