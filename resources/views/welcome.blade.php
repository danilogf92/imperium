    ...
    <body class="app-guest bg-custom">
        ...
        <nav class="bg-custom flex flex-wrap items-center justify-between gap-4 py-6 w-full lg:px-48 md:px-12 px-4 content-center bg-secondary border">
            ...
            @if (Route::has('login'))
                <div class="flex flex-wrap items-center gap-2 text-right z-10">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-white bg-stone-800 hover:bg-stone-600 focus:outline-none focus:ring focus:ring-gray-400 focus:ring-opacity-50 rounded-md px-4 py-2 transition duration-300 ease-in-out">{{ __('Dashboard') }}</a>
                    @else
                        <a href="{{ route('login') }}" class="font-semibold text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-gray-400 focus:ring-opacity-50 rounded-md px-4 py-2 transition duration-300 ease-in-out">{{ __('Login') }}</a>
                        ...
                        @if (Route::has('register'))
                           ...
                           <a href="#" class="font-semibold text-white bg-stone-800 hover:bg-stone-600 focus:outline-none focus:ring focus:ring-gray-400 focus:ring-opacity-50 rounded-md px-4 py-2 transition duration-300 ease-in-out">{{ __('Register') }}</a>
                        @endif
                    @endauth
                </div>
            @endif
        ...
        <section class="md:mt-0 md:h-screen flex flex-col md:flex-row md:justify-between md:items-center lg:px-24 md:px-6 p-4 text-center md:text-left">
            <div class="md:flex-1 md:mr-10">
                ...
                <p class="text-justify p-2">
                    {{ __('Efficient Industrial Project Management Software Our software streamlines industrial project management, simplifying every phase from planning to execution. Designed for various sectors, we offer tools for detailed planning, resource allocation, budget management, and real-time tracking.') }}
                </p>

                <p class="text-justify p-2">
                    {{ __('Ensure projects meet deadlines and budgets with our platform. Maximize efficiency, minimize costs, and take your company to the next level.') }}
                </p>
            </div>

            <div class="flex justify-around md:block mt-8 md:mt-0 md:flex-1">
                <div class="hero-visual w-full" role="img" data-caption="{{ __('PROJECT • PLAN • EXECUTE') }}" aria-label="{{ __('Project management dashboard illustration') }}"></div>
            </div>
        </section>
        ...
        <section class="bg-black text-white sectionSize py-4">
            ...
            <div class="flex-1 mx-8 flex flex-col items-center my-4">
                ...
                <h3 class="font-montserrat font-medium text-xl mb-2">{{ __('Create') }}</h3>
                <p class="text-center font-montserrat">
                    {{ __('Begin by creating a project in our software. Input project details, objectives, and scope. Define the timeline and allocate necessary resources') }}
                </p>
            </div>
            <div class="flex-1 mx-8 flex flex-col items-center my-4">
                <div class="bg-white border-2 rounded-full bg-secondary text-black h-12 w-12 flex justify-center items-center mb-3">
                ...
                <h3 class="font-montserrat font-medium text-xl mb-2">{{ __('Update') }}</h3>
                <p class="text-center font-montserrat">
                    {{ __('Continuously update and monitor your project\'s progress. Easily make changes, update schedules, and adapt to any evolving requirements.') }}
                </p>
            </div>
            <div class="flex-1 mx-8 flex flex-col items-center my-4">
                <div class="bg-white border-2 rounded-full bg-secondary text-black h-12 w-12 flex justify-center items-center mb-3">
                ...
                <h3 class="font-montserrat font-medium text-xl mb-2">{{ __('Schedule') }}</h3>
                <p class="text-center font-montserrat">
                    {{ __('Effectively schedule tasks, deadlines, and milestones within our platform. Keep your project on track with automated reminders and real-time updates') }}
                </p>
            </div>
            </div>
        </section>
            ...
            <div>
                <div class="text-center pt-2 pb-8">
                    ...
                    <span class="text-2xl italic font-extrabold bg-left-bottom bg-no-repeat pb-10 bg-100%" style="background-image: url('{{ asset('img/Underline3.svg') }}');">
                        {{ __('Software Features Description') }}
                    </span>
                </div>
                ...
                <div class="flex items-start font-montserrat my-6 mr-10">
                    ...
                    <div>
                    <h3 class="font-semibold text-2xl">{{ __('Precise Planning and Tracking #1') }}</h3>
                    <p class="text-justify py-2">
                        {{ __('An effective project management software should offer detailed planning capabilities with scheduling and task assignment tools. Furthermore, it should enable real-time tracking of project progress through Gantt charts and dashboards. This ensures that teams can quickly adjust their activities to meet deadlines and objectives.') }}
                    </p>
                    </div>
                </div>
                ...
                <div class="flex items-start font-montserrat my-6 mr-10">
                    <img src='dist/assets/logos/Heart.svg' alt='' class="h-7 mr-4" />
                    <div>
                    <h3 class="font-semibold text-2xl">{{ __('Integrated Collaboration and Communication #2') }}</h3>
                    <p class="text-justify py-2">
                        {{ __('Effective communication is crucial in project management. The software should facilitate collaboration among team members through chats, online comments, and document sharing. Integration with email and video conferencing tools is also essential to keep all stakeholders informed and connected.') }}
                    </p>
                    </div>
                </div>
                ...
                <div class="flex items-start font-montserrat my-6 mr-10">
                    <img src='dist/assets/logos/Heart.svg' alt='' class="h-7 mr-4" />
                    <div>
                    <h3 class="font-semibold text-2xl">{{ __('Resource and Cost Management #3') }}</h3>
                    <p class="text-justify py-2">
                        {{ __('To ensure proper resource allocation and cost control, project management software should provide features to manage budget, time, and human resources. This includes tracking working hours, expense management, and efficient resource scheduling to avoid overloads and delays.') }}
                    </p>
                    </div>
                </div>
                ...
                <div class="flex items-start font-montserrat my-6 mr-10">
                    <img src='dist/assets/logos/Heart.svg' alt='' class="h-7 mr-4" />
                    <div>
                        <h3 class="font-semibold text-2xl">{{ __('Reporting and Analysis Generation #4') }}</h3>
                        <p class="text-justify py-2">
                            {{ __('Customizable reports and analytical capabilities are essential for assessing project performance and making informed decisions. Good software should provide clear data visualizations, status reports, and trend analysis so that managers can identify areas for improvement and take corrective actions in a timely manner. These features help optimize the decision-making process in project management.') }}
                        </p>
                    </div>
                </div>
        ...
        <section class="bg-black sectionSize">
            <div class="text-white text-sm text-center py-4 font-extrabold italic">
                <a href="https://danilo-tech.com" target="_blank"
                    ...
                    &copy; <?php echo date('Y'); ?> {{ __('Danilo tech. All rights reserved') }}
